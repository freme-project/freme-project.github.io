...
* The `apiurl` parameter should be the subpath to the FREME Api that all requests made from this documentation site go to, e.g. {{site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol}}
