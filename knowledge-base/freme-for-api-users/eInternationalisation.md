...
```
curl -X POST -d @docTest.html "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol }}/e-entity/freme-ner/documents?language=en&dataset=dbpedia&mode=all&outformat=turtle"  -H "Content-Type:text/html"
```
...
```
curl -X POST -d @docTest.html "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol }}/e-entity/freme-ner/documents?language=en&dataset=dbpedia&mode=all&outformat=csv&filter=extract-entities-only"  -H "Content-Type:text/html"
```
...
```
curl -X POST -d @docTest.html "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol }}/e-entity/freme-ner/documents?language=en&dataset=dbpedia&mode=all&outformat=text/html"  -H "Content-Type:text/html"
```
...
```
curl -X POST -d @docTestWithEntity.html --header "Content-Type: text/html" "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol }}/e-link/documents/?outformat=turtle&templateid=3"
```
...
```
curl -X POST -d @docTest.html --header "Content-Type: text/html"  "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol  }}/e-terminology/tilde?outformat=turtle&source-lang=en&target-lang=it&mode=full"
```
...
```
curl -X POST -d @docTest.html --header "Content-Type: text/html"  "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol  }}/e-terminology/tilde?outformat=xml&source-lang=en&target-lang=it&mode=full&filter=terminology-terms-only"
```
...
```
curl -X POST -d @docTest.html --header "Content-Type: text/html" --header "Accept: text/html" "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol  }}/e-terminology/tilde?source-lang=en&target-lang=it&mode=full"
```
...
```
curl -X POST -d @docTest-Translation.html --header "Content-Type: text/html" --header "Accept: text/n3" "{{ site.apiBasePath | prepend: site.apiHost | prepend: "://" | prepend: site.apiProtocol  }}/e-translation/tilde?source-lang=en&target-lang=it"
```
