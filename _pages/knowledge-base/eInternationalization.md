...
If the original document contains ITS 2.0 properties, they are translated to proper NIF properties from the <span style="color:blue" title="itsrdf is a commonly used technical prefix in RDF for namespace http://www.w3.org/2005/11/its/rdf describing ITS 2.0 / RDF Ontology.">itsrdf</span> domain (see [Supported ITS categories](#supported-its-categories) section).
